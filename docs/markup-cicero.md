...
The markup language is intended to act as a standard format for expressing contracts in a natively computable manner; namely forms 2 and 3. It is compatible with other industry standard markup and messaging formats:
